    ...
    <section id="aboutSection">
      ...
      <div className='aboutContainer'>
        <div>
          <article>
            <p>
              Hei, jeg er Abdi. Jeg er en webutvikler, interessert i fullstack web utvikling. Å se koden du har skrevet bli til   noe var det som inspirerte meg til å begynne på kodehode.
            </p><br />
            <p>
