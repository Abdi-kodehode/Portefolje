...
const Icons = () => {
    return (
      <div className="iconBar">
          <a href="https://github.com/Abdi-kodehode" rel="noreferrer" target="_blank"><SiGithub size={30} color='#fff' /></a>
          <a href="https://mail.google.com" mailto="abdifatah.hersi@gmail.com" ><SiGmail size={30} color='#fff' /></a>
